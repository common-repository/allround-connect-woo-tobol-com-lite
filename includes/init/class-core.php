...
use ACBOL_Lite\Includes\Interfaces\{
...
class Core implements Action_Hook_Interface, Filter_Hook_Interface {
	 ...
	 * @since    1.0.2
	 * @access   protected
	 * @var      string $acbol_lite The string used to uniquely identify this plugin.
	 */
	protected $acbol_lite;
	...
	public function __construct(
		...
		if ( defined( 'ACBOL_Lite_VERSION' ) ) {
			$this->plugin_version = ACBOL_Lite_VERSION;
		} else {
			$this->plugin_version = '1.0.2';
		}
		if ( defined( 'ACBOL_Lite_MAIN_NAME' ) ) {
			$this->acbol_lite = ACBOL_Lite_MAIN_NAME;
		} else {
			$this->acbol_lite = 'plugin-name';
		}
	...
	public function init_core() {
		...
		if ( $this->is_need_run_init_test ) {
			...
			$this->write_log_during_execution(
				...
				ACBOL_Lite_LOGS . 'execution-log.txt',
				'Test sample 1 '
			);
